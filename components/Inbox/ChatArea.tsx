...
const ChatArea = ({ setOpenComponent }: { setOpenComponent: any }) => {
  ...
  return (
    <View className="w-full h-full border border-gray-100 rounded-md mb-[76px]">
      ...
      <View className="h-[80px] w-full bg-slate-50 p-2 flex flex-row items-center gap-x-3">
        <Image
        ...
        <View className="flex flex-col gap-y-1">
          ...
          <Text className="text-xl font-bold text-activeColor">TK, 4998</Text>
        </View>
      </View>
      <ScrollView style={{ marginBottom: 65 }}>
        <View
          ...
          className=" pt-3 px-2 pb-4 flex flex-col gap-y-5  overflow-auto"
        >
